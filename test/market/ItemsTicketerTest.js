...
describe("ItemsTicketer", function() {
    ...
    let ticketURI, ticketURIBase = "https://api.seen.haus/ticket/metadata/items-ticketer/";
        ...
        context("Privileged Access", async function () {
            ...
            context("Proxy", async function () {
                ...
                it("setImplementation() should require UPGRADER to set the implementation address", async function () {
                    ...
                    // UPGRADER attempt
                    await itemsTicketerProxy.connect(upgrader).setImplementation(replacementAddress);
                ...
                it("setAccessController() should require UPGRADER to set the accessController address", async function () {
                    ...
                    // ADMIN attempt
                    await itemsTicketerProxy.connect(upgrader).setAccessController(replacementAddress);
                ...
                it("setMarketController() should require UPGRADER to set the marketController address", async function () {
                    ...
                    // UPGRADER attempt
                    await itemsTicketerProxy.connect(upgrader).setMarketController(replacementAddress);
