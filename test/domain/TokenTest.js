...
describe("Token", function() {
    ...
    context("Utility functions", async function () {
        ...
        it("Token.fromObject() should return a Token instance with the same values as the given plain object", async function() {
            ...
            // Promote to instance
            const promoted = Token.fromObject(object);

            // Is a Token instance
            expect(promoted instanceof Token).is.true;
        ...
        it("instance.toString() should return a JSON string representation of the Token instance", async function() {
        ...
        it("instance.clone() should return another Token instance with the same property values", async function() {

            // Get plain object
            const clone = token.clone();

            // Is an Token instance
            expect(clone instanceof Token).is.true;
        ...
        it("instance.toObject() should return a plain object representation of the Token instance", async function() {

            // Get plain object
            const object = token.toObject();

            // Not an Token instance
            expect(object instanceof Token).is.false;
